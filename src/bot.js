...
// Para no comprar el mismo listing si llega por WS y polling simultáneamente
...
async function main() {
  ...
  process.on('SIGINT', async () => {
    ...
    detenerDashboard();
    cerrarWebSocket();
    logEvento('bot_pausado', 'Bot detenido por SIGINT');
    process.exit(0);
  });
